...
<body>
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <!-- linea 129 header.php --> <a class="nav-link nav-profile d-flex align-items-center pe-0"
                        href="#" data-bs-toggle="dropdown">
                        <img src="data:image/jpg/png;base64,<?php echo base64_encode($_SESSION['foto']) ?>" id="fot"
                            alt="Foto de perfil" style="width: 40px; height: 40px;" class="rounded-circle">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <?php endif; ?>
            <?php if ($_SESSION['puesto'] === 1 || $_SESSION['puesto'] === 6 || $_SESSION['puesto'] === 11 || $_SESSION['puesto'] === 12 || $_SESSION['puesto'] === 5): ?>
                    <li class="nav-item">
            ...
            <?php if ($_SESSION['puesto'] == 2): ?>
                    <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-target="#pa-nav" data-bs-toggle="collapse"
                            ...
                            <i class="bi bi-file-person-fill"></i><span>Mis pacientes</span><i
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-target="#rua-nav" data-bs-toggle="collapse"
                            href="<?php echo $url_base; ?>secciones/Padministradora/index.php">
                            <i class="bi bi-pin-map-fill"></i><span>Generar ruta</span><i
                                class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        ...
                        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <li>
                                <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#alta" href="#"><i
                                        class="bi bi-circle"></i><span>Dar de Alta</span><i
                                        class="bi bi-chevron-down ms-auto fs-6"></i></a>
                                <ul id="alta" class="collapse">
                                    <li><a href="<?php echo $url_base; ?>secciones/enfermeria/alta/codigo_servicios/index.php"><i
                                                class="bi bi-circle"></i><span>Código</span></a></li>
                                    <li><a href="<?php echo $url_base; ?>secciones/enfermeria/alta/cpts/index.php"><i
                                                class="bi bi-circle"></i><span>Cpts</a></li>
                                    <li><a href="<?php echo $url_base; ?>secciones/enfermeria/alta/administradora/index.php"><i
                                                class="bi bi-circle"></i><span>Administradora</a></li>
                                </ul>
                            </li>
                            <!--Aquí vamos a crear los procesos a realizar-->
                            <li><a class="nav-link" data-bs-toggle="collapse" data-bs-target="#crear" href="#"><i
                                        class="bi bi-circle"></i><span>Crear proceso</span><i
                                        class="bi bi-chevron-down ms-auto fs-6"></i></a>
                                <ul id="crear" class="collapse">
                                    <li><a href="<?php echo $url_base; ?>secciones/enfermeria/hojaComplementaria/index.php"><i
                                                class="bi bi-circle"></i><span>Pacientes</span></a></li>
                                    <li><a href="<?php echo $url_base; ?>secciones/enfermeria/procedimientos/index.php"><i
                                                class="bi bi-circle"></i>Procedimientos</span></a></li>
                                    <li><a href="<?php echo $url_base; ?>secciones/enfermeria/lectura/index.php"><i
                                                class="bi bi-circle"></i>Historial Aseguradoras</span></a></li>
                            </li>
                        </ul>
                        <!-- Módulo de Servicios -->
                    <li>
        ...
        <?php if ($_SESSION['puesto'] === 11): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed"
                        href="<?php echo $url_base; ?>secciones/enfermeria/user/pages/indexPacientes.php">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed"
                        href="<?php echo $url_base; ?>secciones/enfermeria/user/pages/indexHorarios.php">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed"
                        href="<?php echo $url_base; ?>secciones/enfermeria/user/pages/indexAsistencias.php">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed"
                        href="<?php echo $url_base; ?>secciones/enfermeria/registroYcuidados/registrosClinicos/registrosCreados.php">
        ...
        <?php if ($_SESSION['puesto'] == 1 || $_SESSION['puesto'] === 5): ?>
                ...
                <li class="nav-item">
                    ...
                    <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#alta" href="#"><i
                                    class="bi bi-circle"></i><span>Eventos</span><i
                                    class="bi bi-chevron-down ms-auto fs-6"></i></a>
                            <ul id="alta" class="collapse">
                                <li><a href="<?php echo $url_base; ?>secciones/call_center/eventos/index.php"><i
                                            class="bi bi-circle"></i><span>Crear Evento</span></a></li>
                                <li><a href="<?php echo $url_base; ?>secciones/call_center/eventos/cancelar/cancelar.php"><i
                                            class="bi bi-circle"></i><span>Cancelar Evento</a></li>
                            </ul>
                        </li>
                        <li>
        ...
        <?php if ($_SESSION['puesto'] === 3 || $_SESSION['puesto'] === 1): ?>
                <li class="nav-item">
                    <a class="nav-link collapsed" data-bs-target="#systemas-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-pc-display-horizontal"></i><span>Sistemas</span><i
                            class="bi bi-chevron-down ms-auto"></i>
                    </a>
