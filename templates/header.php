...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#services" href="#">
                            <i class="bi bi-circle"></i><span>Servicios</span><i
            ...
            <li class="nav-item">
                <a class="nav-link collapsed"
                    href="<?php echo $url_base; ?>secciones/enfermeria/user/pages/indexAsistencia.php">
            ...
            <li>
                <a class="nav-link collapsed"
                    href="<?php echo $url_base; ?>secciones/enfermeria/registroYcuidados/index.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-telephone-fill"></i><span> Call Center</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo $url_base; ?>secciones/call_center/crearAsistecia/index.php">
                            <i class="bi bi-circle"></i><span>Crear Asistencia</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-person-circle"></i><span>Capital Humano</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
