            ...
            <div class="card-body" style="border: 2px solid #BFE5FF;"> <br>
                <form action="./rutaADD.php" method="POST" class="row g-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <br>
                        <a role="button" href="<?php echo $url_base; ?>secciones/Padministradora/rutas/Buscar.php" name="cancelar" class="btn btn-outline-info"> Buscar de nuevo</a>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <a role="button" href="<?php echo $url_base; ?>secciones/Padministradora/rutas/index.php" name="cancelar" class="btn btn-outline-danger"> Cancelar</a>
                    </div>
