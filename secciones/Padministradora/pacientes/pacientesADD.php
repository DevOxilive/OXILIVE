...
if ($_POST) {
    ...
    $sentencia = $con->prepare("INSERT INTO `pacientes_oxigeno` (`id_pacientes`, `Nombres`, `Apellidos`, `calle`,`num_in`,`num_ext`,`colonia`,`cp`,`municipio`,`estado_direccion`,`rfc`,`responsable`,`Genero`, `Edad`, `Alcaldia`, `Telefono`, `Administradora`, `Aseguradora`, `Banco`, `No_nomina`, `referencias`,`estado`)
    VALUES (Null, :Nombres, :Apellidos, :calle,:num_in,:num_ext,:colonia,:cp,:municipio,:estado_direccion,:rfc,:responsable, :Genero, :Edad,:Alcaldia, :Telefono, :Administradora, :Aseguradora, :Banco, :No_nomina,:referencias,1);");
    ...
    $otra_carpeta_usuario = "../../oxigeno/pacientes/PAPELETA/" . $Apellidos . " " . $Nombres;
