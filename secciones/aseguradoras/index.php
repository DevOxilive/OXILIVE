    ...
    <div class="row">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Aseguradora</h3>
                <hr>
                <div class="btn-box d-flex justify-content-between">
                    <div class="d-flex justify-content-first">
                        <a name="" id="" class="btn btn-outline-primary" href="crear.php" role="button">
                            <i class="bi bi-hospital-fill"></i> Registrar aseguradora
                        </a>
                    </div>
                    <div class="d-flex justify-content-end">
                        <a class="btn btn-outline-dark" href="aseguradora.php" role="button">
                            ...
                            <?php foreach ($lista_aseguradoras as $registro) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a class="btn btn-outline-warning" href="editar.php?txtID=<?php echo $registro['id_aseguradora']; ?>" role="button"><i class="bi bi-pencil-square"></i></a>
                                        |
                                        <a class="btn btn-outline-danger" onclick="eliminar(<?php echo $registro['id_aseguradora']; ?>)" role="button"><i class="bi bi-trash-fill"></i></a>
                                    </td>
                                </tr>
