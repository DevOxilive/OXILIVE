            ...
            <div class="card-body" style="border: 2px solid #BFE5FF;">
                <form action="empleadosADD.php" method="POST" enctype="multipart/form-data" class="row g-3" id="formulario" novalidate>
                    ...
                    <div class="contenido col-md-5" id="nombresBox">
                        ...
                        <input type="text" class="form-control only-letters" name="nombres" id="nombres" placeholder="Ingrese el/los nombre(s)" minlength="5" maxlength="40" required>
                    </div>
                    <div class="contenido col-md-5" id="apellidosBox">
                        <label for="apellidos" class="form-label">Apellidos: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control only-letters" name="apellidos" id="apellidos" placeholder="Ingrese los apellidos" minlength="10" maxlength="40" required>
                    </div>
                    ...
                    <!-- INE -->
                    <div class="contenido col-md-5" id="ineAnversoBox">
                        <label for="ineAnverso" class="form-label">Credencial de Elector (Anverso): <span class="text-danger">*</span></label>
                        <input type="file" class="form-control" name="ineAnverso" id="ineAnverso" required>
                    </div>
                    <div class="contenido col-md-5" id="ineReversoBox">
                        <label for="ineReverso" class="form-label">Credencial de Elector (Reverso): <span class="text-danger">*</span></label>
                        <input type="file" class="form-control" name="ineReverso" id="ineReverso" required>
                    </div>
                    ...
                    <div class="contenido col-md-5" id="actaNacimientoBox">
                        ...
                        <input type="file" class="form-control" name="actaNacimiento" id="actaNacimiento" required>
                    </div>
