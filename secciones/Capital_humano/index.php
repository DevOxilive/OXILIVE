                                                    ...
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td><span
                                                                        class="badge text-bg-success <?php echo ($listado['contrato'] == 'SI CONTRATADO') ? 'success' :'text-bg-danger'; ?> fs-6"><?php echo $listado['contrato']; ?></span>
                                                                </td>
                                                                <td><a class="btn btn-primary"
                                                                        href="empleados/editar.php?txtID=<?php echo $listado['id_empleado']; ?>"
                                                                        role="button"> <i
