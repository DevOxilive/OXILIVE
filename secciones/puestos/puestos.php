...
function Header()   
{
    ...
    $this->MultiCell(260, 5, utf8_decode('Listado de Puestos y Departamentos'), 0, 'C');
    // Salto de línea
    $this->Ln(25);
...
$pdf->Cell(80, 10,'Nombre del puesto',1, 0, 'C', 0);
    $pdf->Cell(60, 10, 'Fecha de registro',1, 1, 'C', 0);
while ($userRow = $sentencia->fetch(PDO::FETCH_ASSOC)) {
    $pdf->SetFont('Arial', '', 12);
    $pdf->Ln(0.6);
    $pdf->setX(15);
    $pdf->Cell(80, 10, utf8_decode($userRow['Nombre_puestos']), 1, 0, 'C', 0);
