            ...
            <div class="card-body" style="border: 2px solid #BFE5FF;"> <br>
                <form action="./usuariosUP.php" method="POST" enctype="multipart/form-data" class="formEdit row g-3">
                        ...
                        <div class="profile-picture">
                            <div class="picture-container">
                                <?php if (!empty($Foto_perfil)) : ?>
                                    <img src="<?php echo $Foto_perfil; ?>" alt="" id="imagenActual" class="img-thumbnail rounded-circle">
                                <?php else : ?>
                                    <img src="./img/default-avatar.png" alt="Foto de perfil" id="imagenActual" class="img-thumbnail">
                                <?php endif; ?>
                                <div class="overlay">
                    ...
                    <div class="contenido col-md-3"><br>
                        ...
                        <input type="text" value="<?php echo $nombres; ?>" class="form-control" name="nombres" id="nombres" placeholder="Ingrese el nombre" required>
                    </div>

                    <div class="contenido col-md-3"><br>
                        <label for="apellidos" class="form-label">Apellidos</label>
                        <input type="text" value="<?php echo $apellidos; ?>" class="form-control" name="apellidos" id="apellidos" placeholder="Apellidos" required>
                    </div>
                    ...
                    <div class="contenido col-md-3">
                        ...
                        <input type="text" value="<?php echo $rfc; ?>" class="form-control" name="rfc" id="rfc" placeholder="rfc" required>
                    </div>

                    <div class="contenido col-md-3">
                        <label for="usuario" class="form-label">Usuario</label>
                        <input type="text" value="<?php echo $usuario; ?>" class="form-control" name="usuario" id="usuario" placeholder="Usuario" required>
                    </div>
                    ...
                    <div class="contenido col-md-3">
                        ...
                        <select id="departamento" name="departamento" class="form-select">
                            <?php foreach ($lista_puestos as $registro) { ?>
                                <option <?php echo ($departamento == $registro['id_puestos']) ? "selected" : ""; ?> value="<?php echo $registro['id_puestos']; ?>">
                    ...
                    <div class="contenido col-md-2">
                        ...
                        <input type="Phone" value="<?php echo $telefono; ?>" class="form-control" name="telefono" id="telefono" placeholder="Telefono de 10 digito">
                    </div>

                    <div class="contenido col-md-3">
                        <label for="email" class="form-label">Correo</label>
                        <input type="email" value="<?php echo $email; ?>" class="form-control" name="email" id="email" placeholder="Ingrese el correo institusional ">
                    </div>
                    ...
                    <div class="contenido col-md-2">
                        ...
                        <select id="status" name="status" class="form-select">
                            <?php foreach ($lista_estado as $registro) { ?>
                                <option <?php echo ($status == $registro['id_estado']) ? "selected" : ""; ?> value="<?php echo $registro['id_estado']; ?>">
                    ...
                    <div class="contenido col-md-2">
                        ...
                        <input type="text" value="<?php echo $alcaldia; ?>" class="form-control" name="alcaldia" id="alcaldia" placeholder="alcaldia" required>
                    </div>

                    <div class="contenido col-md-1">
                        <label for="num_interior" class="form-label">Numero Interior</label>
                        <input type="text" value="<?php echo $num_interior; ?>" class="form-control" name="num_interior" id="num_interior" placeholder="num_interior" required>
                    </div>

                    <div class="contenido col-md-1">
                        <label for="num_exterior" class="form-label">Numero Exterior</label>
                        <input type="text" value="<?php echo $num_exterior; ?>" class="form-control" name="num_exterior" id="num_exterior" placeholder="num_exterior" required>
                    </div>
                    <div class="contenido col-md-2">
                        <label for="codigo_postal" class="form-label">Codigo Postal</label>
                        <input type="text" value="<?php echo $codigo_postal; ?>" class="form-control" name="codigo_postal" id="codigo_postal" placeholder="codigo_postal" required>
                    </div>

                    <div class="contenido col-md-2">
                        <label for="calleUno" class="form-label">Entre Calle:</label></label>
                        <input type="text" value="<?php echo $calleUno; ?>" class="form-control" name="calleUno" id="calleUno" placeholder="calleUno" required>
                    </div>

                    <div class="contenido col-md-2">
                        <label for="calleDos" class="form-label">Y calle:</label>
                        <input type="text" value="<?php echo $calleDos; ?>" class="form-control" name="calleDos" id="calleDos" placeholder="calleDos" required>
                    </div>
                    <div class="contenido col-md-4">
                        <label for="referencias" class="form-label">Referencias</label>
                        <input type="text" value="<?php echo $referencias; ?>" class="form-control" name="referencias" id="referencias" placeholder="referencias" required>
                    </div>
                        ...
                        <div class="profile-picture-cre">
                            <div class="picture-container-cre">
                                <?php if (!empty($credencialFrente)) : ?>
                                    <img src="<?php echo $credencialFrente; ?>" alt="" id="imagenActual1" class="img-thumbnail-ine" style="width: 350px ; height: 210px;">
                                <?php else : ?>
                                    <img src="<?php echo $credencialFrente; ?>" alt="foto de perfil" id="imagenActual1" class="img-thumbnail-ine">
                                <?php endif; ?>
                        ...
                        <div class="profile-picture-cre">
                            <div class="picture-container-cre">
                                <?php if (!empty($credencialAtras)) : ?>
                                    <img src="<?php echo $credencialAtras; ?>" alt="" id="imagenActual2" class="img-thumbnail-ine" style="width: 350px ; height: 210px;">
                                <?php else : ?>
                                    <img src="<?php echo $credencialAtras; ?>" alt="foto de perfil" id="imagenActual2" class="img-thumbnail-ine">
                                <?php endif; ?>
                                <div class="overlay-cre">
