            ...
            <div class="card-body">
                <form action="./guardarEvento.php" method="POST" class="formLogin row g-3 needs-validation" id="formulario" novalidate>
                    ...
                    <div class="contenido col-md-3">
                        ...
                        <input type="date" id="fechaServicio" onkeydown="return false" name="fechaServicio" class="form-control" required>
                        <div class="invalid-tooltip">Selecciona una fecha</div>
                    </div>
                    <div class="contenido col-md-3 position-relative">
                        ...
                        <div class="invalid-tooltip">Selecciona una hora</div>
                    </div>
                    <div class="contenido col-md-11">
                        ...
                        <div class="invalid-feedback">Introduzca un motivo de consulta</div>
                    </div>

                    <div class="contenido col-md-3 position-relative">
                        <label for="nAutorizacion" class="form-label">N° Autorizacion:</label>
                        <input type="text" class="form-control" name="nAutorizacion" id="nAutorizacion" placeholder="Eje: 452k01" required>
                        <div class="invalid-tooltip">N° de autorización no válido</div>
                    </div>
                    <div class="contenido col-md-3">
                        <label for="auEspecial" class="form-label">No. Autorizacion especial:</label>
                        <input type="text" class="form-control" name="auEspecial" id="auEspecial" placeholder="Eje: MDF12421" required>
                    </div>
                    <div class="contenido col-md-5">
                        ...
                        <select class="form-select" name="asignarMedico" id="asignarMedico">
                            ...
                            <?php
                            foreach ($datos_medicos as $medicos) {
                            ...
                            ?>
                            <!-- Opción para representar "ningún médico seleccionado" (valor nulo) -->
                            <option value="">Ningún médico</option>
                        </select>
                    </div>
