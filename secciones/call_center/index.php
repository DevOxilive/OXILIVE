        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                    <div class="card">
                        <div class="card-body">
                            <p class="mt-2" style=""><strong style="color:brown"> Bienvenido <br>Que tenga un buen día</strong></p>
                            <img src="data:image/jpg/png;base64,<?php echo base64_encode($_SESSION['foto']) ?>" id="fot" alt="Foto de perfil" class="img-fluid mt-3">
                            <p class="mt-2" style=""><strong style="color:brown" id="servicio-status"></strong></p>
                        </div>
                    </div>
                </div>
            </div>
