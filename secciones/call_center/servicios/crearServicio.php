                ...
                <form action="./model/agregarServicio.php" method="POST" class="formLogin row g-3" id="formulario">
                    ...
                    <div class="contenido col-md-6"> <br>
                        <div class="formulario__grupo" id="grupo__nomServicio">
                            ...
                            <div class="formulario__grupo-input">
                                <input type="text" class="form-control" name="nomServicio" id="nomServicio" placeholder="Eje: VISITA MEDICA DOMICILIARIA">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contenido col-md-6"> <br>
                        <div class="formulario__grupo" id="grupo__descripServicio">
                            ...
                            <div class="formulario__grupo-input">
                                <input type="text" class="form-control" name="descripServicio" id="descripServicio" placeholder="Eje: horario de 07:00 a las 20:00 hrs. ">
                            </div>
                        </div>
                    </div>
