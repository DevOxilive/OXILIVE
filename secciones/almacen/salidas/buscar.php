  ...
  <div class="card">
    <div class="card-header" style="border: 2px solid #012970; background: #005880;">
      <h4
        ...
        Buscar producto para salida</h4>
    </div>
    <div class="card-body" style="border: 2px solid #BFE5FF;"> <br>
      <form action="./salida.php" method="POST" class="row g-3">

        <label for="buscar_material" class="form-label">Nombre del Material ó Producto</label>
        <div class="input-group mb-3">
          <input type="text" class="form-control" id="search_material" name="buscar_material"
