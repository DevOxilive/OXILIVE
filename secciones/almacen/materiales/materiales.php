...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->MultiCell(260, 5, utf8_decode('INVENTARIO'), 0, 'C');
        // Salto de línea
        $this->Ln(25);
    }
    // Pie de página
...
$sentencia = $con->prepare("SELECT * FROM almacen");
$sentencia->execute();
$pdf->Ln(0.6);
$pdf->setX(15);
$pdf->SetFont('Times', 'B', 12);
$pdf->Cell(50, 10, 'Nombre del producto',1, 0, 'C', 0);
$pdf->Cell(40, 10, 'Cantidad existente',1, 0, 'C', 0);
$pdf->Cell(40, 10, 'Cantidad adecuada',1, 0, 'C', 0);
$pdf->Cell(55, 10, 'Fecha de entrada', 1, 1, 'C', 0);
while ($userRow = $sentencia->fetch(PDO::FETCH_ASSOC)) {
    $pdf->SetFont('Arial', '', 11);
    $pdf->setX(15);
    $pdf->Cell(50, 10, utf8_decode($userRow['nombre']), 1, 0, 'C', 0);
    $pdf->Cell(40, 10, utf8_decode($userRow['cantidad']), 1, 0, 'C', 0);
    $pdf->Cell(40, 10, utf8_decode($userRow['cantidad_adecuada']), 1, 0, 'C', 0);
