    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-body" style="border: 2px solid #BFE5FF;">
                <form action="./proceADD.php" method="POST" enctype="multipart/form-data" class="formLogin row g-3" id="formulario">
                ...
                <div class="contenido col-md-4">
                    ...
                    <div class="contenido col-md-5">
                        ...
                        <div class="formulario__grupo" id="grupo__Nombre_aseguradora">
                            ...
                            <div class="formulario__grupo-input">
                                <input type="text" class="formulario__input" name="medico" id="medico" placeholder="Alan Garcia">
                                <i class="formulario__validacion-estado bi bi-exclamation-triangle-fill"></i>
                            </div>
                        </div>
                    </div>
