...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->MultiCell(260, 5, ('Listado de Bancos'), 0, 'C');
        // Salto de línea
        $this->Ln(25);
    }
    // Pie de página
