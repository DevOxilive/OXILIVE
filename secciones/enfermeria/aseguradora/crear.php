    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-body" style="border: 2px solid #BFE5FF;">
                <form action="./aseguADD.php" method="POST" enctype="multipart/form-data" class="formLogin row g-3" id="formulario">
    ...
    function confirmCancel(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php echo $url_base; ?>secciones/enfermeria/aseguradora/index.php";
            }
        });
    }
</script>
