    ...
    <section class="section dashboard">
        <div class="card">
            ...
            <div class="card-body" style="border: 2px solid #BFE5FF;">
                <form action="./aseguUP.php" method="POST" class="row g-3 formEdit">
                    ...
                    <div class="contenido col-md-3"> <br>
                        ...
                        <select id="administradora" name="administradora" class="form-select">
                            ...
                            <option <?php echo ($administradora == $registro['id_admi_enfer']) ? "selected" : ""; ?>
                                value="<?php echo $registro['id_admi_enfer']; ?>">
    ...
    function mostrarAlertaCancelar() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '<?php echo $url_base; ?>secciones/enfermeria/index.php';
            }
        })
    }
</script>
