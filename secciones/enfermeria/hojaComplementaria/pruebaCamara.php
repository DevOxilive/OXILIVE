                ...
                <form action="./pacientesADD.php" method="post" enctype="multipart/form-data" class="formLogin row g-3" id="formulario">
                        ...
                        <div class="profile-picture-cre">
                            <div class="picture-container-cre ">
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php } ?>
                                <div class="overlay-cre controller">
                                    <?php if (empty($Credencial_aseguradora)) { ?>
                                        <a href="#" class="change-link" onclick="openFilePicker2(event)">
                                        <i class="fa-regular fa-image" ></i>
                                        <i class="fa fa-camera snap"></i> <!--Snap nombre que captura imagen-->
                                        </a>
                                    <?php } else { ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="profile-picture-cre">
                            <div class="picture-container-cre">
                                ...
                                <div class="overlay-cre">
                                    ...
                                    <button type="button" class="btn btn-info" id='btnCapture'><i class="fa fa-camera" id="snap"></i></button> 
                                    <!--<button id="btnCapture"> <i class="fa fa-camera" id="snap"></i></button>-->
                                    <?php } else { ?>
                                        <a href="#" class="delete-link" onclick="deletePhoto3(event)">Eliminar foto</a>
                                    <?php } ?>
                            </div>                         
                        </div><br>
                        <!--Inserto de video para el acceso a camara-->
                        ...
                        <input type="file" class="form-control" name="Credencial_aseguradoras_post" id="Credencial_aseguradoras_post" onchange="previewImage3(this);" style="display: none;" accept="application/jpg">
                                    </div><!--Div de termino de icon camara-->
                   ...
                   <!-- <div class="col-10">
                        <div class="formulario__grupo formulario__grupo-btn-enviar">
                            ...
                            <a role="button" onclick="confirmCancel(event)" name="cancelar" class="btn btn-outline-danger">
                                ...
                                <div class="col">
                            <button id="btnDownloadImage" class="formulario__btn btn  btn-outline-success">Descargar Imagen</button>
                            </div>
                            </div>
                        -->
                    </div>
                      ...
                      <div class="row justify-content-center formulario__grupo formulario__grupo-btn-enviar">
                             ...
                             <a role="button" onclick="confirmCancel(event)" name="cancelar" class="btn btn-outline-danger">Cancelar</a>
                                  ...
                                  <div class="col-md-auto ">
                                  <button id="btnDownloadImage" class="formulario__btn btn  btn-outline-success"> Descargar</button>
                             </div>
                                </div>
                        <!--Fin del row-->
                </form>
