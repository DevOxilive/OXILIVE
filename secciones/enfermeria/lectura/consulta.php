...
pacientes_oxigeno po , codigo_administradora codigo
...
FROM procedimientos p, usuarios u, 
pacientes_oxigeno po , codigo_administradora codigo , administradora ad
WHERE p.medico = u.id_usuarios
AND p.pacienteYnomina = po.id_pacientes
...
FROM procedimientos p, usuarios u, 
pacientes_oxigeno po , codigo_administradora cp
WHERE p.medico = u.id_usuarios
AND p.pacienteYnomina = po.id_pacientes
