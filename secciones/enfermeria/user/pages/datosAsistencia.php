                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <img style="width:300px; height: 400px;" src="<?php echo $asis['checkFotografia']; ?>" alt="Foto de Asistencias">
                            </div>
                        </div>
                    </div>
                    <div class="card">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <iframe width="300" height="220" style="border:0" loading="lazy" allowfullscreen referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps/embed/v1/place?key=API_KEY&q=Space+Needle,Seattle+WA">
                            </iframe>
                        </div>
                    </div>
                </div>
