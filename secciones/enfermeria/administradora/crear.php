                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo" id="grupo__Nombre_administradora">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="Nombre_administradora"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="cpt" id="cpt"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="des1" id="des1"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="unidad" id="unidad"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="cpt2" id="cpt2"
                                        placeholder="EN-BA-03">
                                    <i class="formulario__validacion-estado bi bi-exclamation-triangle-fill"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="des2" id="des2"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="unidad2" id="unidad2"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="cpt3" id="cpt3"
                                        placeholder="EN-BA-03">
                                    <i class="formulario__validacion-estado bi bi-exclamation-triangle-fill"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="des3" id="des3"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="unidad3" id="unidad3"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="cpt4" id="cpt4"
                                        placeholder="EN-BA-03">
                                    <i class="formulario__validacion-estado bi bi-exclamation-triangle-fill"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="des4" id="des4"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="unidad4" id="unidad4"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="cpt5" id="cpt5"
                                        placeholder="EN-BA-03">
                                    <i class="formulario__validacion-estado bi bi-exclamation-triangle-fill"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="des5" id="des5"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="unidad5" id="unidad5"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="cpt6" id="cpt6"
                                        placeholder="EN-BA-03">
                                    <i class="formulario__validacion-estado bi bi-exclamation-triangle-fill"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="des6" id="des6"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="formulario__grupo">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="text" class="formulario__input" name="unidad6" id="unidad6"
                                        placeholder="Turno 8 Horas">
                                    <i class="formulario__validacion-estado bi bi-exclamation-triangle-fill"></i>
                                </div>
                            </div>
