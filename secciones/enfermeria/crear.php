        ...
        <div class="card">
            ...
            <div class="card-body" style="border: 2px solid #BFE5FF;">
                <form action="<?php echo $url_base ?>secciones/usuarios/usuariosADD.php" method="POST"
                    ...
                    <!-- Inicio de sección de foto -->
                    <div class="col-md-2">
                        <label for="Foto_perfil" class="form-label">Sube una foto de perfil</label>
                        <div class="profile-picture">
                            <div class="picture-container">

                                <!-- Valida si tiene foto o no. Si no tiene, devuelve una por defecto -->
                                ...
                                <div class="overlay">
                                    ...
                                    <!-- Te permite subir una foto si no tienes una -->
                                    <?php if (empty($Foto_perfil)) { ?>
                    ...
                    <!-- Fin de sección de foto  -->

                    <!-- Inicio texto del formulario -->
                    ...
                    <!-- El departamento tendrá por default Enfermería para evitar registrar otro tipo de usuario -->
                    <div class="contenido col-md-2">
                    ...
                    <div class="contenido col-md-6">
                        ...
                        <input type="text" class="form-control" name="referencias" id="referencias"
                            placeholder="Ejem. Frente a tiendita">
                    </div>
                    <!-- Fin texto del formulario -->

                    <!-- Inicio archivos del formulario -->
