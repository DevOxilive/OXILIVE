...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->MultiCell(260, 5, utf8_decode('Listado de Encargados de Oxigeno (Choferes)'), 0, 'C');
        // Salto de línea
        $this->Ln(25);
    }
    // Pie de página
...
$pdf->Cell(80, 10, 'Nombre del chofer',1, 0, 'C', 0);
$pdf->Cell(60, 10, 'Fecha de ingreso', 1, 1, 'C', 0);
while ($userRow = $sentencia->fetch(PDO::FETCH_ASSOC)) {
    $pdf->SetFont('Arial', '', 12);
    $pdf->setX(15);
    $pdf->Cell(80, 10, utf8_decode($userRow['Nombre_completo']), 1, 0, 'C', 0);
