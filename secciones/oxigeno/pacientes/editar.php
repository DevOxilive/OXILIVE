                ...
                <form action="./pacientesUP.php" method="post" enctype="multipart/form-data" class="row g-3 formEdit">
                    ...
                    <div class="contenido col-md-2"> <br>
                        ...
                        <input type="text" value="<?php echo $Nombres; ?>" class="form-control" name="Nombres"
                            id="Nombres" aria-describedby="helpId" placeholder="Nombres" required>
                    </div>

                    <div class="contenido col-md-3"> <br>
                        <label for="Apellidos" class="form-label">Apellidos</label>
                        <input type="text" value="<?php echo $Apellidos; ?>" class="form-control" name="Apellidos"
                            id="Apellidos" aria-describedby="helpId" placeholder="Apellidos" required>
                    </div>
                    <div class="contenido col-md-3"> <br>
                    ...
                    <div class="contenido col-md-1"> <br>
                        ...
                        <input type="number" value="<?php echo $Edad; ?>" class="form-control" name="Edad" id="Edad"
                    ...
                    <div class="contenido col-md-3">
                        ...
                        <input type="text" value="<?php echo $calle; ?>" class="form-control" name="calle" id="calle"
                            aria-describedby="helpId" placeholder="Direccion" required>
                    </div>
                    <div class="contenido col-md-2">
                        <label for="num_in" class="form-label">Núm. Int</label>
                        <input type="text" value="<?php echo $num_in; ?>" class="form-control" name="num_in" id="num_in"
                            aria-describedby="helpId" placeholder="Direccion" required>
                    </div>
                    <div class="contenido col-md-2">
                        <label for="num_ext" class="form-label">Núm. Ext</label>
                        <input type="text" value="<?php echo $num_ext; ?>" class="form-control" name="num_ext"
                            id="num_ext" aria-describedby="helpId" placeholder="Direccion" required>
                    </div>
                    <div class="contenido col-md-3">
                        <label for="colonia" class="form-label">Colonia</label>
                        <input type="text" value="<?php echo $colonia; ?>" class="form-control" name="colonia"
                            id="colonia" aria-describedby="helpId" placeholder="Direccion" required>
                    </div>
                    <div class="contenido col-md-3">
                        <label for="municipio" class="form-label">Municipio</label>
                        <input type="text" value="<?php echo $municipio; ?>" class="form-control" name="municipio"
                            id="municipio" aria-describedby="helpId" placeholder="Direccion" required>
                    </div>
                    <div class="contenido col-md-2">
                        <label for="cp" class="form-label">Código Postal</label>
                        <input type="text" value="<?php echo $cp; ?>" class="form-control" name="cp" id="cp"
                            aria-describedby="helpId" placeholder="Direccion" required>
                    </div>
                    <div class="contenido col-md-3">
                        <label for="estado_direccion" class="form-label">Estado:</label>
                        <input type="text" value="<?php echo $estado_direccion; ?>" class="form-control"
                            name="estado_direccion" id="estado_direccion" aria-describedby="helpId"
                            placeholder="Direccion" required>
                    </div>
                    <div class="contenido col-md-6">
                        <label for="responsable" class="form-label">Responsable</label>
                        <input type="text" value="<?php echo $responsable; ?>" class="form-control" name="responsable"
                            id="responsable" aria-describedby="helpId" placeholder="Direccion" required>
                    </div>
                    ...
                    <div class="contenido col-md-3">
                        ...
                        <input type="text" value="<?php echo $Alcaldia; ?>" class="form-control" name="Alcaldia"
                            id="Alcaldia" aria-describedby="helpId" placeholder="Alcaldia" required>
                    </div>

                    <div class="contenido col-md-3">
                        <label for="referencias" class="form-label">Referencias</label>
                        <input type="text" value="<?php echo $referencias; ?>" class="form-control" name="referencias"
                            id="referencias" aria-describedby="helpId" placeholder="referencias" required>
                    </div>
                    ...
                    <div class="contenido col-md-3">
                        ...
                        <select id="Aseguradora" name="Aseguradora" class="form-select">
                            ...
                            <option <?php echo ($Aseguradora == $registro['id_aseguradora']) ? "selected" : ""; ?>
                                value="<?php echo $registro['id_aseguradora']; ?>">
                    ...
                    <div class="contenido col-md-4">
                        ...
                        <input type="text" value="<?php echo $Nomina; ?>" class="form-control" name="Nomina"
                            id="Nomina " aria-describedby="helpId" placeholder="Nomina" required>
                    </div>

                    <div class="col-md-3">
                        <label for="comprobante" class="form-label">Comprobante de domicilio, Ver: <a
                                href="./PAPELETA/<?php echo $Apellidos . " " . $Nombres ?>/<?php echo $comprobante; ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="profile-picture-cre">
                            <div class="picture-container-cre">
                                ...
                                <img src="./PAPELETA/<?php echo $Apellidos . " " . $Nombres ?>/<?php echo $Credencial_front; ?>"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="profile-picture-cre">
                            ...
                            <div class="picture-container-cre">
                                ...
                                <img src="./PAPELETA/<?php echo $Apellidos . " " . $Nombres ?>/<?php echo $Credencial_post; ?>"
                    ...
                    <!--  -->
                    <div class="col-md-4">
                        <label for="Credencial_aseguradora" class="form-label">(ASEGURADORA) Credencial parte
                            superior</label>
                        <br>
                        <div class="profile-picture-cre">
                            <div class="picture-container-cre">
                                <?php if (!empty($Credencial_aseguradora)) : ?>
                                <img src="./PAPELETA/<?php echo $Apellidos . " " . $Nombres ?>/<?php echo $Credencial_aseguradora; ?>"
                    ...
                    <div class="col-md-4">
                        <label for="Credencial_aseguradoras_post" class="form-label">(ASEGURADORA) Credencial parte
                            inferior</label>
                        <br>
                        <div class="profile-picture-cre">
                            ...
                            <div class="picture-container-cre">
                                ...
                                <img src="./PAPELETA/<?php echo $Apellidos . " " . $Nombres ?>/<?php echo $Credencial_aseguradoras_post; ?>"
