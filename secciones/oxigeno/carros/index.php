...
<main id="main" class="main">
    ...
    <div class="card-header" style="text-align: right;">
                    <a class="btn btn-outline-dark" href="indexpdf.php" role="button"><i class="bi bi-printer-fill"></i></a>
            </div>
        <div class="card">
                ...
                <div class="table-responsive-sm">
                    <table class="table border-dark table-hover" id="myTable" style="border: 1px solid black">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                <th scope="row">
                                    <?php echo $registro['id_carro']; ?>
                                </th>
                                <th scope="row">
                                    <?php echo $registro['modelo']; ?>
                                </th>
                                <th scope="row">
                                    <?php echo $registro['Nombre_carro']; ?>
                                </th>
                                <th scope="row">
                                ...
                                <td style="text-align: center;">
                                    <a class="btn btn-outline-warning"
                                        href="editar.php?txtID=<?php echo $registro['id_carro']; ?>" role="button"><i
                                            class="bi bi-pencil-square"></i></a>
                                    |
                                    <a class="btn btn-outline-danger"
                                        onclick="eliminar(<?php echo $registro['id_carro']; ?>)" role="button"><i
