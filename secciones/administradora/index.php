                            ...
                            <?php foreach ($lista_administradora as $registro) { ?>
                                <tr class="" style="text-align: center; ">
                                    ...
                                    <td style="text-align: center;">
                                        <a class="btn btn-outline-warning" href="editarAdmin.php?txtID=<?php echo $registro['id_administradora']; ?>" role="button"><i class="bi bi-pencil-square"></i></a>
                                        |
                                        <a class="btn btn-outline-danger" onclick="eliminar(<?php echo $registro['id_administradora']; ?>)" role="button"><i class="bi bi-trash-fill"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
